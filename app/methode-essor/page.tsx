...
export const metadata: Metadata = {
  title: "Méthode ESSOR : pilotage de dirigeant de TPE/PME à La Réunion",
  description:
...
export default function MethodeEssorPage() {
  return (
    <>
      <section className="section section-cream section-first">
        <div className="container">
          <PageLead
            ...
            text="De l'état des lieux à la performance, en 12 ou 24 mois. Quatre étapes pour piloter les yeux ouverts."
          />
      ...
      <section
        className="section section-photo essor-vs-section"
        style={{
          backgroundImage:
            "linear-gradient(rgba(8,8,8,0.62), rgba(8,8,8,0.74)), url(/essor-vs-bg.jpg)",
        }}
      >
        <div className="container">
          <div className="essor-compare">
            <Reveal className="essor-compare-head center">
            ...
            <div className="essor-compare-grid">
              <Reveal className="essor-vs essor-vs-not" delay={100}>
                <div className="essor-vs-head">
                  <span className="essor-vs-icon" aria-hidden="true">
          ...
          <div className="essor-fit-layout essor-fit-layout-2col">
            <div className="essor-fit-cols">
              <Reveal className="essor-fit-card essor-fit-card-yes" delay={100}>
                ...
                <ul>
                  <li>Vous dirigez seul et n&apos;avez pas les moyens d&apos;un directeur financier</li>
                  <li>Vous êtes dans l&apos;opérationnel et perdez le recul</li>
                  <li>Vous traversez un plateau de stagnation</li>
              ...
              <Reveal className="essor-fit-card essor-fit-card-no" delay={200}>
                ...
                <ul>
                  ...
                  <li>Vous n&apos;êtes pas prêt à investir 3-4h par mois</li>
          ...
          <div className="origine-layout">
            ...
            <div className="origine-steps">
              ...
              <Reveal className="origine-step" delay={200}>
                ...
                <div>
                  <h3>La rigueur</h3>
                  <p>Affinée avec son associé, de formation comptable, pour ancrer chaque décision dans les chiffres.</p>
                </div>
              </Reveal>
              <Reveal className="origine-step" delay={300}>
                ...
                <div>
                  <h3>Depuis 2021</h3>
                  <p>Appliquée au pilotage des TPE/PME, avant une vente ou après un rachat.</p>
                </div>
              </Reveal>
            </div>
          </div>
